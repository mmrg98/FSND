...
his project uses YARN to manage software dependencies. After cloning, open your terminal and run:
...
The frontend app was built using create-react-app. In order to run the app in development mode use ```yarn start```. You can change the script in the ```package.json``` file. 
